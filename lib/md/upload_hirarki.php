...
<section class="content connectedSortable">
  <div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs pull-right">
      <li class="pull-left header"><i class="fa fa-inbox"></i> Upload File PDF untuk Hirarki Level</li>
    </ul>
...
<script>
  $(document).ready(function() {
    ...
    $('.tte_oleh').select2({
      ajax: {
        url: './lib/base/select_data_custom.php?t=0&filter=all&rolefilter=level_hirarki',
        dataType: 'json',
    ...
    function sendFile(files) {
      ...
      $(".uploadBtn").on("click", function() {
        ...
        dataFrom.append("tipe_send_dokumen", "hirarki");
