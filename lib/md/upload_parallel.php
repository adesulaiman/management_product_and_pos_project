    ...
    <div class="tab-content no-padding">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="chart tab-pane active" style="position: relative; height: 300px;padding:10px">
          ...
          <h4 class="text-center">Upload Satu Dokumen Docx</h4>
          <div class="chart tab-pane active" style="position: relative; height: 300px;padding:10px">
            <div class="file_drag_area_docx">
              <img src="assets/img/docx.png" class="imgDragDocx" width="100px" /><br>
              Drop atau Click File Disini
              <input type="file" name="dokumen" accept=".docx" class="docxFile" style="display: none;" />
            </div>
          </div>
...
<script>
  $(document).ready(function() {
    ...
    $('.file_drag_area_docx').on('dragover', function() {
      $(this).addClass('file_drag_over_docx');
      return false;
    });

    $('.file_drag_area_docx').on('dragleave', function() {
      $(this).removeClass('file_drag_over_docx');
      return false;
    });

    $('.file_drag_area_docx').on('drop', function(e) {
      e.preventDefault();
      $(this).removeClass('file_drag_over_docx');
      ...
      $.ajax({
        ...
        success: function(msg) {
          ...
          if (msg.status == 'success') {
            ...
            $(".framePDF").attr("src", "https://docs.google.com/gview?url=<?php echo $dir ?>assets/upload/" + msg.docx + "&embedded=true");
            ...
            $(".uploadBtn").on("click", function() {
              ...
              dataFrom.append("docx", msg.docx);
              dataFrom.append("tipe_send_dokumen", "parallel");
              dataFrom.append("dokumen_type", "singleDocx");
