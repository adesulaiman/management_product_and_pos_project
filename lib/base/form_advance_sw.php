...
<script>
  ...
  $('.formSubmit').on('click', function() {
    ...
    $.ajax({
      method: "POST",
      url: "./lib/base/save_data_with_sw.php",
      data: dataFrom,
      processData: false,
      contentType: false,
      dataType: 'json',
  ...
  function report(id) {
    window.open('./lib/report/generate_pdf.php?template=stockweight&idstockopname=' + id, "popupWindow", "width=900, height=600, scrollbars=yes");
  }
</script>