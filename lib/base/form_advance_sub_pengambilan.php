...
?>
    ...
    <section class="content-header">
      <h1>
        <button onclick="HtmlLoad('./lib/base/<?php echo $script ?>?f=<?php echo $fParent ?>','');" class='btn btn-danger'>< Back</button> <?php echo $formDesc ?>
      </h1>
      <ol class="breadcrumb">
...
$('.filterAdvCheck').click(function(){
    ...
    var table = $("#<?php echo $formName ?>").DataTable({
      ...
      buttons: [
          ...
          {
            text: '<i class="fa fa-pencil-square-o"></i> Pengambilan',
