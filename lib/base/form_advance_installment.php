...
<script>
    ...
    var table = $("#<?php echo $formName ?>").DataTable({
        ...
        buttons: [{
            ...
            {
                text: '<i class="fa fa-list"></i> Print Nota',
                ...
                action: function(e, dt, node, config) {
                    ...
                    if (rowData == null) {
                        ...
                        console.log(rowData.id_invoice);
                        window.open('./lib/report/generate_pdf.php?template=nota_installment&struk=' + rowData.id_invoice, "popupWindow", "width=900, height=600, scrollbars=yes");
                    }
    ...
    $('.formSubmit').on('click', function() {
        ...
        $.ajax({
            method: "POST",
            url: "./lib/base/save_data_forsub.php",
            data: dataFrom,
            processData: false,
            contentType: false,
            dataType: 'json',
            ...
            ";
              ...
              ";
                ...
                if (type == "add") {
                    ...
                    $("[name=invoice]").val("INVR-" + Math.random().toString(36).slice(2).toUpperCase());
                }
