...
<script>
  ...
  var table = $("#<?php echo $formName ?>").DataTable({
    ...
    "serverSide": true,
    "ajax": {
      "url": "./lib/base/load_data_ifm.php?t=<?php echo $formView ?>&f=<?php echo $f ?>",
      "data": function(data) {
  ...
  $('.formSubmit').on('click', function() {
    ...
    $.ajax({
      method: "POST",
      url: "./lib/base/save_data_ifm.php",
      data: dataFrom,
      processData: false,
      contentType: false,
      dataType: 'json',
  ...
  function loadForm(id, type) {
    ...
    $.ajax({
      method: "POST",
      url: "./lib/base/form_modal_act_ifm.php?f=<?php echo $f ?>&type=" + type + val,
      success: function(msg) {
